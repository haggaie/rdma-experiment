...
לשרת וגם ללקוח אחרת יתקבלו תוצאות שגויות. בנוסף, perftest עשוי להדפיס אזהרה כאשר תדר השעון של המעבד אינו תואם לתדר המקסימלי שלו. ניתן להתעלם מאזהרה זו.
...
מדדו את קצב העברת הנתונים באמצעות ib\_write\_bw תוך שימוש בהודעות גדולות (גודל ברירת המחדל). מדדו במהלך הריצה את
