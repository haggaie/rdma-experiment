...
כדי לראות את השפעת מספר התהליכים על קצב ההעברה, שרטטו גרף המשווה את קצב ההעברה 
(הודעות לשניה) כפונקציה של מספר התהליכים. הפעילו תהליך נפרד של `ib_send_bw` על כל אחת מהליבות בשרת (באמצעות
